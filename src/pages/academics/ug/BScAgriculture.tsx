...
const data: DeptPageProps = {
  ...
  gallery: [
    {
      src: "/A.I.E.T CAMPUS -2026-180.jpg",
      alt: "Field Practicals",
    ...
    {
      src: "/A.I.E.T CAMPUS -2026-467.jpg",
      alt: "Soil Lab",
      caption: "Soil Science Laboratory",
      placeholder: "🔬",
      bg: "linear-gradient(135deg, #1e3a5f, #0c4a6e)",
    },
    {
      src: "/A.I.E.T CAMPUS -2026-185.jpg",
      alt: "Kisan Mela",
      caption: "Annual Kisan Mela 2024",
      placeholder: "🌻",
    ...
    },
    {
      src: "/A.I.E.T CAMPUS -2026-467.jpg",
      alt: "Greenhouse",
      caption: "Protected Cultivation — Greenhouse",
      placeholder: "🏡",
      bg: "linear-gradient(135deg, #064e3b, #065f46)",
    },
    {
      src: "/A.I.E.T CAMPUS -2026-423.jpg",
      alt: "Vermicompost Unit",
      caption: "ELP — Vermicompost Enterprise",
      placeholder: "🪱",
