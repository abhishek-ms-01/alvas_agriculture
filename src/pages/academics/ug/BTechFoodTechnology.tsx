...
const data: DeptPageProps = {
  ...
  gallery: [
    ...
    },
    {
      ...
      alt: "Sensory Analysis",
      caption: "Sensory Evaluation Lab",
      placeholder: "👅",
      bg: "linear-gradient(135deg, #0a2e05, #14532d)",
    },
    {
      src: "https://images.unsplash.com/photo-1523348830342-d0187cf0c283?auto=format&fit=crop&q=80&w=800",
      alt: "Bakery Workshop",
      caption: "Confectionery & Bakery Workshop",
      placeholder: "🥐",
    ...
    },
    {
      ...
      alt: "Quality Control",
      caption: "Food Quality Control & Assurance",
      placeholder: "⚖️",
    ...
    },
    {
      src: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&q=80&w=800",
      alt: "Packaging Lab",
      caption: "Food Packaging & Shelf-life Studies",
      placeholder: "📦",
