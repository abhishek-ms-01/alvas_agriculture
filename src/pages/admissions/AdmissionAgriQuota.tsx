    ...
    <div className="adm-page">
      ...
      <main>
        <PageHero
          ...
          badgeText="Admissions — Agri Quota"
          title={<>Admission Through <span className="text-accent">Agri Quota</span></>}
          subtitle="Specialized admission pathway for students from agricultural backgrounds, dedicated to fostering the next generation of farming experts and agricultural scientists."
          stats={[
            { bold: "Reserved", text: "Seats" },
            { bold: "Farmer", text: "Background" },
            { bold: "Special", text: "Ranks" },
          ]}
        />
