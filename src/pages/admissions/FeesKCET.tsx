      ...
      <main>
        <div className="adm-hero">
          ...
          <div className="adm-hero-content">
            <div className="adm-badge"><DollarSign size={14} /> Fees — KCET Students</div>
            <h1 className="adm-title">Fee Structure — <span>KCET Students</span></h1>
            <p className="adm-subtitle">
              KCET category fees are regulated by the Karnataka government and the Karnataka Examinations Authority. Below is the detailed fee structure for students admitted through KCET.
            </p>
            <div className="adm-stat-row">
              <div className="adm-stat-pill"><strong>Govt.</strong> Regulated</div>
