...
graph TD
    ...
    subgraph Vercel ["☁️ Vercel Cloud (CDN)"]
        Build["📦 Static Build\n(dist/)"]
    end

    subgraph App ["⚛️ React SPA — Vite + TypeScript"]
        direction TB
        Entry["🚪 main.tsx\nApp Entry Point"]

        subgraph Layout ["🔲 App Shell — App.tsx"]
            InfoBanner["📢 InfoBanner\n(CET Code Bar)"]
            Header["🧭 Header\n(Navigation + Dropdowns)"]
            ScrollTop["⬆️ ScrollToTop"]
            Footer["🦶 Footer\n(Links + Map + Social)"]
        end

        subgraph Router ["🔀 React Router DOM v6"]
            Home["🏠 /\nIndex.tsx"]
            About["ℹ️ /about/*\n10+ Sub-pages"]
        ...
        subgraph Components ["🧩 Reusable Components"]
            ...
            PlaceSec["PlacementsSection"]
            PageHero["PageHero\n(Shared Banner)"]
        end

        subgraph UILayer ["🎨 UI & Animation Layer"]
            ShadCN["shadcn/ui\n30+ Components"]
        ...
        subgraph Hooks ["🪝 Custom Hooks"]
            ScrollHook["useScrollAnimation"]
            MobileHook["useMobile"]
            ToastHook["useToast"]
        end
    end

    User -->|"HTTPS Request"| Vercel
    Vercel -->|"Serves HTML/JS/CSS"| Entry
    Entry --> Layout
    Layout --> Router
    Router --> Components
    Components --> UILayer
    ...
    classDef user fill:#16a34a,stroke:#15803d,color:#fff,rx:10
    classDef cloud fill:#1e40af,stroke:#1d4ed8,color:#fff
    classDef default fill:#1f2937,stroke:#374151,color:#e5e7eb
```
...
```mermaid
flowchart TD
    A(["🌐 User visits\nalvas-agriculture.vercel.app"]) --> B

    B["☁️ Vercel CDN\nServes static build"] --> C

    C["📄 index.html loads\nmain.tsx bootstraps React"] --> D

    D["⚛️ App.tsx mounts\nReact Router initializes"] --> E

    E{"🔀 URL Route\nMatching"}

    E -->|"/"| F["🏠 Home Page\nIndex.tsx"]
    E -->|"/about/*"| G["ℹ️ About Pages\n10 sub-routes"]
    E -->|"/admissions/*"| H["🎓 Admissions\n7 sub-routes"]
    E -->|"/research/*"| I["🔬 Research\n12 sub-routes"]
    E -->|"/campus-life/*"| J["🌿 Campus Life\n6 sub-sections"]
    E -->|"Other routes"| K["📄 Placements\nContact, Internship\nExposure, Academics"]
    ...
    L["🔲 App Shell Wraps Every Page"]

    L --> M["📢 InfoBanner\n(CET Code Bar)"]
    L --> N["🧭 Header\n(Responsive NavBar + Dropdowns)"]
    L --> O["📄 Page Content\n(Framer Motion Animated)"]
    L --> P["🦶 Footer\n(Links + Map + Social)"]
    L --> Q["⬆️ ScrollToTop\n(Auto on route change)"]

    O --> R["🧩 Shared Components"]
  ...
  <tr>
    <td align="center" width="300">
      ...
      <a href="https://github.com/abhishek-ms-01">
        <img src="https://img.shields.io/badge/GitHub-abhishek--ms--01-181717?style=for-the-badge&logo=github" alt="GitHub"/>
      </a>
    </td>
    <td align="center" width="300">
      <br/>
      ...
      <img src="https://img.shields.io/badge/Developer-Omkar%20K%20S-16a34a?style=for-the-badge&logo=react" alt="Developer"/>
    </td>
  </tr>
</table>
...
[![Made with React](https://img.shields.io/badge/Made%20with-React%20%2B%20TypeScript-61DAFB?style=flat-square&logo=react)](https://react.dev)
[![Styled with Tailwind](https://img.shields.io/badge/Styled%20with-TailwindCSS-06B6D4?style=flat-square&logo=tailwindcss)](https://tailwindcss.com)
